...
public class TestConfig{
	...
	public static String from = "anjithacheriyanmarate@gmail.com";
	public static String password = "anuamal#2705";
	public static String[] to ={"anjithacheriyanmarate@gmail.com","testuseribm2495@gmail.com"};
